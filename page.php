...
<?php elseif (get_row_layout() == 'singleimage') : ?>
<?php get_template_part('template-parts/singleimage'); ?>
<?php elseif (get_row_layout() == 'specialise_block') : ?>
<?php get_template_part('template-parts/specialise-block'); ?>
<?php elseif (get_row_layout() == 'project_block') : ?>
<?php get_template_part('template-parts/project_block'); ?>
<?php endif; ?>
<?php endwhile; ?>
<?php endif; ?>
